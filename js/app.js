 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".js-basket")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".js-basket")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("basket-open");
                }
            }));
            if (document.querySelector(".js-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".js-menu")) {
                    bodyLockToggle();
        ...
        const inputMasksCard = document.querySelectorAll(".card-mask");
        const inputMasksPeriod = document.querySelectorAll(".card-period");
        const inputMasksPassword = document.querySelectorAll(".card-password");
        if (inputMasksCard.length) modules_flsModules.inputMasksCard = Inputmask({
            mask: "9999-9999-9999-9999",
            showMaskOnHover: false,
            showMaskOnFocus: false
        }).mask(inputMasksCard);
        if (inputMasksPeriod.length) modules_flsModules.inputMasksPeriod = Inputmask({
            mask: "99/99",
            showMaskOnHover: false,
            showMaskOnFocus: false
        }).mask(inputMasksPeriod);
        if (inputMasksPassword.length) modules_flsModules.inputMasksPassword = Inputmask({
            mask: "999",
            showMaskOnHover: false,
            showMaskOnFocus: false
        }).mask(inputMasksPassword);
        ...
        function initSliders() {
            if (document.querySelector(".scroll-nav__slider")) new core(".scroll-nav__slider", {
            ...
            if (document.querySelector(".carousel__slider-two")) new core(".carousel__slider-two", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        function headerScroll() {
            ...
            const startPoint = header.dataset.scroll ? header.dataset.scroll : 130;
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                scrollDirection = scrollTop <= 1e3 ? 0 : scrollTop;
            }));
        }
        ...
        const cropElement = document.querySelectorAll(".product-card__desc"), size = 50, endCharacter = "...";
